...
function buildNotifyMentionData(plugin: any): { prefix: string; allowedMentions: { parse: string[]; roles?: string[] } } {
...
export function buildNotifyPayload(plugin: any, alert: any, serverKey: string, serverName: string, playerCount: number): {
  content: string;
  allowed_mentions: {
    parse: string[];
    roles?: string[];
